...
def insert_data_into_advanced_game_editor(self):
	...
	self.gameInformationEditorAdvancedSettings.graphic_panel_x_dimension_textentry.set_text("%i" % self.gameInformation.graphic_panel_x_dimension)
	self.gameInformationEditorAdvancedSettings.graphic_panel_y_dimension_textentry.set_text("%i" % self.gameInformation.graphic_panel_y_dimension)
	self.gameInformationEditorAdvancedSettings.default_mouse_pointer_graphic_textentry.set_text(self.gameInformation.default_mouse_pointer_graphic)
	...
	self.gameInformationEditorAdvancedSettings.display_help_button_checkbutton.set_active(self.gameInformation.display_help_button)
	...
	self.gameInformationEditorAdvancedSettings.graphical_compass_x_icon_number_textentry.set_text("%i" % self.gameInformation.graphical_compass_x_icons)
	self.gameInformationEditorAdvancedSettings.graphical_compass_y_icon_number_textentry.set_text("%i" % self.gameInformation.graphical_compass_y_icons)
	self.gameInformationEditorAdvancedSettings.graphical_compass_panel_padding_textentry.set_text("%i" % self.gameInformation.graphical_compass_panel_padding)
	self.gameInformationEditorAdvancedSettings.graphical_compass_blank_icon_textentry.set_text(self.gameInformation.graphical_compass_background_image)
	self.gameInformationEditorAdvancedSettings.graphical_compass_graphic_not_available_icon_textentry.set_text(self.gameInformation.graphical_compass_graphic_not_available_icon)
	...
	self.gameInformationEditorAdvancedSettings.menu_button_display_position_textentry.set_text("%i" % self.gameInformation.menu_button_display_position)
	...
	self.gameInformationEditorAdvancedSettings.graphical_inventory_panel_padding_textentry.set_text("%i" % self.gameInformation.graphical_inventory_panel_padding)
	...
	self.gameInformationEditorAdvancedSettings.graphical_object_panel_x_display_coordinate_textentry.set_text("%i" % self.gameInformation.object_panel_Xoffset)
	self.gameInformationEditorAdvancedSettings.graphical_object_panel_y_display_coordinate_textentry.set_text("%i" % self.gameInformation.object_panel_Yoffset)
	...
	self.gameInformationEditorAdvancedSettings.object_panel_padding_textentry.set_text("%i" % self.gameInformation.object_panel_padding)
...
def read_advanced_game_editor_data_into_memory(self):
	...
	try:
		current_number = string.atoi(self.gameInformationEditorAdvancedSettings.graphic_panel_x_dimension_textentry.get_text())
	except ValueError:
		self.display_dialog_box("Error", "Non-integer entered into Graphic Panel X Dimension's number field")
	else:
		self.gameInformation.graphic_panel_x_dimension = current_number

	try:
		current_number = string.atoi(self.gameInformationEditorAdvancedSettings.graphic_panel_y_dimension_textentry.get_text())
	except ValueError:
		self.display_dialog_box("Error", "Non-integer entered into Graphic Panel Y Dimension's number field")
	else:
		self.gameInformation.graphic_panel_y_dimension = current_number

	self.gameInformation.default_mouse_pointer_graphic = self.gameInformationEditorAdvancedSettings.default_mouse_pointer_graphic_textentry.get_text()
	...
	self.gameInformation.display_help_button = self.gameInformationEditorAdvancedSettings.display_help_button_checkbutton.get_active()
	try:
	...
	try:
		current_number = string.atoi(self.gameInformationEditorAdvancedSettings.graphical_compass_x_icon_number_textentry.get_text())
	except ValueError:
		self.display_dialog_box("Error", "Non-integer entered into Graphical Compass Button Number of X Icons number field")
	else:
		self.gameInformation.graphical_compass_x_icons = current_number

	try:
		current_number = string.atoi(self.gameInformationEditorAdvancedSettings.graphical_compass_y_icon_number_textentry.get_text())
	except ValueError:
		self.display_dialog_box("Error", "Non-integer entered into Graphical Compass Button Number of Y Icons number field")
	else:
		self.gameInformation.graphical_compass_y_icons = current_number

	try:
		current_number = string.atoi(self.gameInformationEditorAdvancedSettings.graphical_compass_panel_padding_textentry.get_text())
	except ValueError:
		self.display_dialog_box("Error", "Non-integer entered into Graphical Compass Panel Padding number field")
	else:
		self.gameInformation.graphical_compass_panel_padding = current_number

	self.gameInformation.graphical_compass_background_image = self.gameInformationEditorAdvancedSettings.graphical_compass_blank_icon_textentry.get_text()
	self.gameInformation.graphical_compass_graphic_not_available_icon = self.gameInformationEditorAdvancedSettings.graphical_compass_graphic_not_available_icon_textentry.get_text()
	...
	try:
		current_number = string.atoi(self.gameInformationEditorAdvancedSettings.menu_button_display_position_textentry.get_text())
	except ValueError:
		self.display_dialog_box("Error", "Non-integer entered into Graphical Compass Help Menu Button Display Position number field")
	else:
		self.gameInformation.menu_button_display_position = current_number
	...
	try:
		current_number = string.atoi(self.gameInformationEditorAdvancedSettings.graphical_inventory_panel_padding_textentry.get_text())
	except ValueError:
		self.display_dialog_box("Error", "Non-integer entered into Graphical Inventory Panel Padding number field")
	else:
		self.gameInformation.graphical_inventory_panel_padding = current_number
	...
	try:
		...
		self.gameInformation.object_panel_Xoffset = current_number
	...
	try:
		...
		self.gameInformation.object_panel_Yoffset = current_number
	...
	try:
		current_number = string.atoi(self.gameInformationEditorAdvancedSettings.object_panel_padding_textentry.get_text())
	except ValueError:
		self.display_dialog_box("Error", "Non-integer entered into Graphical Object Panel Padding number field")
	else:
		self.gameInformation.object_panel_padding = current_number
