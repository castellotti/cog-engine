...
def insert_data_into_obstruction_editor(self, current_obstruction_number):
	...
	if (self.obstructionData[self.obstruction_displayed].icon_graphic_url == None):
...
def read_obstruction_editor_data_into_memory(self):
	...
	if (self.obstructionEditor.name_textentry.get_text() != ""):
		try:
			...
			self.obstructionData[current_obstruction_number].icon_graphic_url = self.obstructionEditor.icon_graphic_textentry.get_text()
			if (self.obstructionData[current_obstruction_number].icon_graphic_url == ""):
				self.obstructionData[current_obstruction_number].icon_graphic_url = None
